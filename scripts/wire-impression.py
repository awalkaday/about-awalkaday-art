...
{{% capture chapter %}}{{% include_relative {rel} %}}{{% endcapture %}}
{{{{ chapter | markdownify }}}}
</section>
"""
...
Path("impression/index.md").write_text(content, encoding="utf-8")
print("Written: impression/index.md")
print(f"Total chapters wired: {len(chapters)}")
